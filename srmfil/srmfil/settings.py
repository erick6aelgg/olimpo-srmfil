"""
Django settings for srmfil project.
...
WSGI_APPLICATION = 'srmfil.wsgi.application'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=env.int('ACCESS_TOKEN_LIFETIME_HOURS', default=7)),
}
